...
const Footer = ({ scrollToSection }) => {
  return (
    <div className="min-h-[270px] py-[40px] px-[10px] w-full flex justify-center items-center gap-[27px] flex-col bg-[#464d53]">
      <div className="flex justify-center items-center gap-[56px] flex-wrap *:text-[#F6F6F6]">
        ...
        <button onClick={() => scrollToSection("identifyGenre")}>Жанры</button>
