...
=======
  return (
    <header
      className="relative bg-cover bg-center head-section h-screen w-full  -mx-4 md:-mx-8 lg:-mx-24 text-start " // Adjust the negative margins
    >
...
>>>>>>> f8abb2e54f4993d1e8f30d052754a836f6380b83
};
