...
import ShadeText from "@/components/ShadeText";
const Head = () => {
	const features = [
		"Улучшить качество JPG изображений: Загружайте фото для улучшения.",
	...
	return (
		...
		>
			<div className="flex flex-col h-[60%] justify-around">
				<h1
					className="font-bold text-4xl md:text-5xl lg:text-6xl text-center md:text-start "
				...
				<img
					src={bgimg}
					alt="bg-img"
					className="md:absolute top-0 right-0 left-0 md:left-[50%] h-[50%] object-contain md:object-contain md:h-[50%] md:top-10 -z-10"
				/>
				{/* <p
					className="mt-4 text-lg md:text-xl lg:text-2xl max-w-5xl hidden md:block text-center md:text-start"
					style={{ fontSize: "1.25rem", lineHeight: "2rem" }}
				>
					<h3 className="text-2xl font-bolder text-center md:text-start">
				...
				<ShadeText features={features} />
				<Button size="sm" className="w-24 mx-auto md:mx-0 bg-red-600">
					Open Channel
				</Button>
			</div>
			<Reviews />
